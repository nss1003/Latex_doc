...
erforderlichen Koeffizienten sind ADC 16-Bit-Werte, die in den internen 
Register des Sensors zu lesen sind. Eine weitere Kalibrierung durch den 
...
\textbar \textpm 500 \textbar \textpm 1000 \textbar \textpm 2000dps 
(Degrees per second).
...
Wie oben schon erl"autert, kann das Ger"at so eingestellet werden, dass 
...
LoRaWAN beschreibt das Komminikationsprotokoll und die 
...
Der verwendete Server heisst \textbf{lorawan-server} (Open-source). Er
...
Nach dem die Build-Targets konfiguriet sind, erscheinen sie in dem 
...
Nun ein Beispiel wie das ganze zu verwenden ist. Jedes Zeichen wird einem nach dem anderen per UART4 gessendet.
